...
function createSnippets({ toggleInlineMath, toggleDisplayMath, usePhysicsPackage = true }) {
    ...
    const snippets = [
        ...
        {trigger: "([a-zA-Z])vaa", replacement: profileReplacement("\\va{[[0]]}", "\\vec{[[0]]}"), options: "rmA", priority: 10},
        {trigger: "([a-zA-Z])vbb", replacement: profileReplacement("\\vb{[[0]]}", "\\mathbf{[[0]]}"), options: "rmA", priority: 10},
        {trigger: "([a-zA-Z])vuu", replacement: profileReplacement("\\vu{[[0]]}", "\\hat{\\mathbf{[[0]]}}"), options: "rmA", priority: 10},
        ...
        {trigger: /\\xi[ \t]*i/, replacement: "x_{i}", options: "rmA", priority: 10},
        ...
        {trigger: "ddn", replacement: profileReplacement("\\dd[$0]{$1}$2", "\\,\\mathrm{d}^{$0}$1$2"), options: "mA", priority: 10},
        {trigger: "pdv0", replacement: profileReplacement("\\pdv{ ${0:x} } $2", "\\frac{\\partial}{\\partial ${0:x}} $2"), options: "mA", priority: 10},
        {trigger: "pdvn", replacement: profileReplacement("\\pdv[$0]{ $1 }{ $2 }$3", "\\frac{\\partial^{$0} $1}{\\partial $2^{$0}}$3"), options: "mA", priority: 20},
        {trigger: "dvn", replacement: profileReplacement("\\dv[$0]{ $1 }{ $2 }$3", "\\frac{\\mathrm{d}^{$0} $1}{\\mathrm{d} $2^{$0}}$3"), options: "mA", priority: 10},
        {trigger: "dvv", replacement: profileReplacement("\\dv{ ${0:y} }{ ${1:x} } $2", "\\frac{\\mathrm{d}${0:y}}{\\mathrm{d}${1:x}}$2"), options: "mA", priority: 10},
        {trigger: "pdvv", replacement: profileReplacement("\\pdv{ ${0:y} }{ ${1:x} } $2", "\\frac{\\partial ${0:y}}{\\partial ${1:x}} $2"), options: "mA", priority: 10},
        ...
        {trigger: "he4",   replacement: "{}^{4}_{2}He ", options: "mA", priority: 10},
        {trigger: "he3",   replacement: "{}^{3}_{2}He ", options: "mA", priority: 10},
